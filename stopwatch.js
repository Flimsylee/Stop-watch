...
const startStpBtn = document.querySelector('#startStpBtn');
...
// variables for setInterval and timer Interval
...
startStpBtn.addEventListener('click', function(){
   ...
   if ( timerStatus === "stopped" ){
      ...
      document.getElementById('startStpBtn').innerHTML = `<i class="fa-solid fa-play"></i>`;
      timerStatus = "stopped"
   }
})
